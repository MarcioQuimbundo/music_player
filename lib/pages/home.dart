...
import 'package:music_player/pages/allmusic.dart';
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text("\nDeveloper: Márcio Teixeira Quimbundo \n\nVersão: 1.0.0"),
          actions: <Widget>[
            FlatButton(
              child: Text("Fechar"),
            ...
            children: <Widget>[
              UserAccountsDrawerHeader(
                ...
                /*currentAccountPicture: GestureDetector(
                  onTap: () {},
                  child: CircleAvatar(
                    backgroundImage: AssetImage('images/icon/music_player.png'),
                  ),
                ),*/         
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    fit: BoxFit.contain,
                    image: AssetImage('images/icon/music_player.png'),
                  ),
                ),
                accountEmail: null,
              ),
              ListTile(
                title: Text('Todas as músicas'), 
                trailing: Icon(Icons.library_music), 
                onTap: () {
                  Navigator.of(context).pop();
                  Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context) => AllMusic()));
                } 
              ),
              ListTile(
                title: Text('Sobre a aplicação'),
